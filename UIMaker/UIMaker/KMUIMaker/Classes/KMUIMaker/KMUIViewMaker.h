...
@property (nonatomic, copy, readonly) KMUIViewMaker * (^addMasorny)(void (^)(MASConstraintMaker *maker));

@property (nonatomic, copy, readonly) KMUIViewMaker * (^remakeMasorny)(void (^)(MASConstraintMaker *maker));

@property (nonatomic, copy, readonly) KMUIViewMaker * (^updateMasorny)(void (^)(MASConstraintMaker *maker));
